...
const apps = [
  ...
  { finished: true, name: 'Day Planner', link: '11-day-planner', element: <DayPlanner /> },
  { finished: true, name: 'Library Search Tool', link: '12-library-search-tool', element: <LibrarySearchTool /> },
