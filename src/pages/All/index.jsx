...
const { ingre, readr, moovee, shopr, submitted, kiddin, locus, taggr, spriddle, sytycj, _123go, devtips, votr, hourly, emply, clist, vroom, docu, writr, txtly, regexpo, algoz, depto, cinem, wander, grader, passo, megen } = appData
...
export default function All() {
  ...
  const games = [spriddle, sytycj, _123go] // removed kiddle for maintenance
